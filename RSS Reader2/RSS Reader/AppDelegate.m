...
- (void)customizeAppearance
{
    ...
    [[UINavigationBar appearance] setTitleTextAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"TrebuchetMS-Bold" size:30.0f], NSForegroundColorAttributeName:[UIColor whiteColor]}];
}
@end
